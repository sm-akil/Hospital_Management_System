...
<body>
  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('ward_create')); ?>" class="btn btn-sm btn-neutral">Add new ward</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <tr>
      <?php $__currentLoopData = $ward_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ward): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($ward->id); ?></td>
      <td><?php echo e($ward->ward_name); ?></td>
      <td><?php echo e($ward->no_bed); ?></td>
      <td>
      <a class="btn btn-sm btn-danger" href="ward_delete/<?php echo e($ward->id); ?>">Delete</a>
      <a class="btn btn-sm btn-neutral" href="ward_update/<?php echo e($ward->id); ?>">Edit</a>
      </td>
      </tr>
