...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Page content -->
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <form method="POST" action="doctor_submit">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="date" placeholder="date of birth"  name="date_of_birth" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
    ...
    <input class="form-control" type="text" placeholder="Contact" name="phone_number"  />
    </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">E-mail</label>
    <input class="form-control"t type="email" placeholder="abc@mubashar.io" name="email" />
    </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
