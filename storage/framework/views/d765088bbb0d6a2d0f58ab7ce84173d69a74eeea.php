        ...
        <div class="col-lg-6 col-md-8">
          <div class="card bg-secondary border-0">
            <div class="card-header bg-transparent pb-5">
              <div class="text-muted text-center mt-2 mb-4"><small><?php echo e(isset($url) ? ucwords($url) : ""); ?> <?php echo e(__('Register')); ?></small></div>
              ...
              <?php if(isset($url)): ?>
                ...
                <div class="form-group">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <!-- <input class="form-control" placeholder="Confrim Password" type="password"> -->
                ...
                <div class="text-center">
                  ...
                  <button type="submit" class="btn btn-primary mt-4"><?php echo e(__('Register')); ?></button>
                </div>
              </form>
            </div>
          </div>
...
<?php /**PATH A:\aHDDProgramm File\XAMM\htdocs\Hospital_Management_System\resources\views/auth/register.blade.php ENDPATH**/ ?>