...
<body>
  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('doctor_create')); ?>" class="btn btn-sm btn-neutral">Add new Doctor</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid mt--6">
          ...
          <div class="card">
            ...
            <?php echo e(session('msg')); ?>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody class="list">
                <?php $__currentLoopData = $doctroarr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($doctor->id); ?></td>
      <td><?php echo e($doctor->fname); ?></td>
      <td><?php echo e($doctor->lname); ?></td>
      ...
      <td>
      <a class="btn btn-sm btn-danger"  href="doctor_delete/<?php echo e($doctor->id); ?>">Delete</a>
      <a class="btn btn-sm btn-neutral" href="doctor_update/<?php echo e($doctor->id); ?>">Edit</a>
      </td>
      </tr>
