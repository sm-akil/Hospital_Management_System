...
<body>
  ...
  <div class="main-content" id="panel">
            ...
            <div class="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li class="breadcrumb-item"><a href="<?php echo e(url('/doctor_show')); ?>">Doctor</a></li>
                  <li class="breadcrumb-item active" aria-current="page">Patient</li>
                </ol>
              </nav>
            </div>
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('patient_create')); ?>" class="btn btn-sm btn-neutral">Add new Patient</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container-fluid mt--6">
      ...
      <tr>
      <?php $__currentLoopData = $patient_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      ...
      <td><?php echo e($patient->address); ?></td>
            <td>
      <a class="btn btn-sm btn-danger" href="patient_delete/<?php echo e($patient->id); ?>">Delete</a>
      <a class="btn btn-sm btn-neutral" href="patient_update/<?php echo e($patient->id); ?>">Edit</a>
      </td>
      </tr>
...
<!--       
      ...
      <td>
      <a href="patient_delete/<?php echo e($patient->id); ?>">Delete</a>
      <a href="patient_update/<?php echo e($patient->id); ?>">Edit</a>
      </td>
      </tr>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      </table>
