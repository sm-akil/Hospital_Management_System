...
<div class="card-body">
            ...
            <form method="POST" action="apoint_submit">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="ssd" name="ssd" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Problem</label>
                        <input class="form-control" type="text" placeholder="problem"   name="problem" required/>
                        </div>
                    </div>
                  </div>
