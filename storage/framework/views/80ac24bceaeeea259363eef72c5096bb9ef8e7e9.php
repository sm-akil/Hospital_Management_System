...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <form method="POST" action="../doctor_update/<?php echo e($doctroarr->id); ?>">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="fname" required value="<?php echo e($doctroarr->fname); ?>" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Last Name</label>
                        <input class="form-control" type="text" name="lname" required value="<?php echo e($doctroarr->lname); ?>"/>
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="date_of_birth" required value="<?php echo e($doctroarr->date_of_birth); ?>"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        <input class="form-check-input" type="radio" name="gender" value="Male" <?php echo e($doctroarr->gender == 'Male' ? 'checked' : ''); ?>/>
                        <label class="form-check-label" for="gridRadios">
                         Male     
                        </label>
                       </div>
                        <div class="form-check">
                       <input class="form-check-input" type="radio" name="gender" value="Female" <?php echo e($doctroarr->gender == 'Female' ? 'checked' : ''); ?>/>
                       <label class="form-check-label" for="gridRadios">
                         Female
                        </label>
                      </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="speciality" required value="<?php echo e($doctroarr->speciality); ?>"/>
                        </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="address"  value="<?php echo e($doctroarr->address); ?>"/>
                        </div>
                    </div>
                  </div>
                  <div class="row">
    ...
    <input class="form-control" type="text" name="phone_number"  value="<?php echo e($doctroarr->phone_number); ?>"/>
    </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-country">E-mail</label>
    <input class="form-control"t type="email" name="email"  value="<?php echo e($doctroarr->email); ?>"/>
    </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
