        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('apointment')); ?>" class="btn btn-sm btn-neutral">Appointment List</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="card-body">
            ...
            <form method="POST" action="../apoint_update/<?php echo e($pointarr->id); ?>">
            <?php echo e(csrf_field()); ?> 
    <h6 class="heading-small text-muted mb-4">Appointment Details</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Name</label>
                        <input class="form-control" type="text" placeholder="Enter your name" name="name" value="<?php echo e($pointarr->name); ?>" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Age</label>
                        <input class="form-control" type="text" placeholder="age"   name="age" value="<?php echo e($pointarr->age); ?>" required/>
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">SSD</label>
                        <input class="form-control" type="text" placeholder="ssd" name="ssd" value="<?php echo e($pointarr->ssd); ?>" required />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Problem</label>
                        <input class="form-control" type="text" placeholder="problem"   name="problem" value="<?php echo e($pointarr->problem); ?>" required/>
                        </div>
                    </div>
                  </div>
