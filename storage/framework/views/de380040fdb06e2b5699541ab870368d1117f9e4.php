      ...
      <div class="container-fluid">
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('ward_show')); ?>" class="btn btn-sm btn-neutral">Ward & Beds List</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <form method="POST" action="../ward_update/<?php echo e($ward_arr->id); ?>">
    <?php echo e(csrf_field()); ?> 
    <h6 class="heading-small text-muted mb-4">Ward & beds info</h6>
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-username">Ward Name</label>
                        <input class="form-control" type="text" required name="ward_name" value="<?php echo e($ward_arr->ward_name); ?>" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Last Name</label>
                        <input class="form-control" type="text" required name="no_bed" value="<?php echo e($ward_arr->no_bed); ?>"/>
                        </div>
                    </div>
                  </div>
