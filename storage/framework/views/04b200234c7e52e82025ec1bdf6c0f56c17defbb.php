      ...
      <div class="container-fluid">
        ...
        <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <form method="POST" action="ward_submit">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Enter ward name"  required name="ward_name" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Beds</label>
                        <input class="form-control" type="text" placeholder="Number of beds" required name="no_bed" />
                        </div>
                    </div>
                  </div>
