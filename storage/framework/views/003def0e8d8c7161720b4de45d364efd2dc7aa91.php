  ...
  <div class="main-content" id="panel">
        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            <div class="col-lg-6 col-7">
              <h6 class="h2 text-white d-inline-block mb-0">Ward & beds info</h6>
            ...
            <div class="col-lg-6 col-5 text-right">
              <a href="<?php echo e(url('doctor_show')); ?>" class="btn btn-sm btn-neutral">Doctor List</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-12 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">
 <form method="POST" action="dep_submit">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="department name"  required name="dept_name" />
                        </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Department detail</label>
                        <input class="form-control" type="text" placeholder="department detail" required name="dept_details" />
                        </div>
                    </div>
                  </div>
    ...
    <div class="table-responsive">
      ...
      <tr>
      <?php $__currentLoopData = $dept_arr; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
      <td><?php echo e($dept->dept_id); ?></td>
      <td><?php echo e($dept->dept_name); ?></td>
      <td><?php echo e($dept->dept_details); ?></td>
      <td>
      <a class="btn btn-sm btn-danger"  href="dept_delete/<?php echo e($dept->dept_id); ?>">Delete</a>
      <!-- <a class="btn btn-sm btn-neutral" href="dept_update/<?php echo e($dept->dept_id); ?>">Edit</a> -->
      </td>
      </tr>
